...
const sidebar = ["Заявки", "Чат", "Пользователи", "Водители", "История"];
  ...
  return (
    <main className="operator-shell">
      ...
      <section className="operator-workspace">
        <header className="operator-header"><div><small>Операторская панель</small><h1>Заявки Smart Taxi</h1></div><label><Icon name="search" /><input placeholder="Поиск заказа или телефона" /></label></header>
