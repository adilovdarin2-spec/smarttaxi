...
const carImages = {
  Economy: "/cars/tariff_economy_smarttaxi_v3.png",
  Comfort: "/cars/tariff_comfort_unbranded_v2.png",
  Business: "/cars/tariff_business_unbranded_v2.png",
  Delivery: "/cars/tariff_delivery_smarttaxi_v3.png"
};
...
const errorMessages = {
  ...
  // Цены у тарифа или направления может не быть: владелец открыл новый
  // регион или добавил дорогу и ещё не проставил цену. Сервер отказывает
  // вместо того, чтобы выдумать сумму, а пассажиру нужна причина.
  PRICE_NOT_CONFIGURED: "Цена на это направление ещё не задана. Выберите другой тариф или попробуйте позже",
  ...
  // Остальные отказы сервера, которые веб-клиент раньше показывал как
  // "что-то пошло не так". Тексты те же, что в приложении.
  ...
  NO_PENDING_PRICE_OFFER: "По этому заказу нет предложения цены",
  OFFERED_PRICE_OUT_OF_BOUNDS: "Такая цена вне допустимых границ. Выберите цену из подсказки",
  ...
  PAYOUT_REQUEST_NOT_PENDING: "Отменить можно только заявку, которую ещё не рассмотрели",
  QUEUED_PRICE_OFFER_NOT_FOUND: "Это предложение цены уже неактуально",
...
export default function ClientApp() {
  ...
  function authMessage(error) {
    ...
    const map = {
      ...
      INVALID_AUTH_RESPONSE: "Сервис не подтвердил вход. Попробуйте ещё раз.",
