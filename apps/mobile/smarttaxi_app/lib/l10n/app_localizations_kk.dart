...
class AppLocalizationsKk extends AppLocalizations {
  ...
  String get passengerFaqA1 =>
      'Картадан алу нүктесі мен межелі мекенжайды таңдаңыз, тарифті таңдаңыз — баға белгілі — және «Тапсырыс беру» түймесін басыңыз.';
  ...
  String get passengerFaqA3 =>
      'Әр ауданның бір сапар бағасы бар, аудандар арасындағы әр жолдың өз бағасы бар. Қашықтық оны өзгертпейді: соманы тапсырыс бергенге дейін көресіз және көбірек не азырақ ұсына аласыз.';
  ...
  @override
  String get driverTopupErrorAmount => 'Толықтыру сомасын тексеріңіз';
  ...
  String get driverFaqA4 =>
      'Клиент осы бағыттағы бағадан жоғары немесе төмен баға ұсына алады. Мұндай тапсырыстар белгімен көрсетіліп, тізімде бірінші болып шығады.';
