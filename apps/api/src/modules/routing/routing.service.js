...
const LOCAL_ADDRESS_HINTS = [
  ...
  },
  {
    ...
    lat: 40.7869,
    lng: 68.5344,
    keywords: ["киров", "кирово", "kirov", "центр киров", "базар киров"]
  },
  {
    label: "Асыката",
    ...
    lat: 40.8947,
    lng: 68.3635,
    keywords: ["асыката", "асықата", "asykata", "центр асыката"]
  },
  {
    label: "Достык",
    ...
    lat: 40.8072,
    lng: 68.4592,
    keywords: ["достык", "достық", "dostyk", "центр достык"]
  },
  {
    label: "Ынтымак",
    ...
    lat: 40.7606,
    lng: 68.4979,
    keywords: ["ынтымак", "ынтымақ", "yntymak", "центр ынтымак"]
  },
  {
    label: "Бирлик",
    ...
    lat: 40.8225,
    lng: 68.4018,
    keywords: ["бирлик", "бірлік", "birlik", "центр бирлик"]
  },
  {
    label: "Фирдоуси",
    subtitle: "Фирдоуси, центр",
    ...
    lat: 40.7231,
    lng: 68.5016,
    keywords: ["фирдоуси", "фердоуси", "firdousi"]
  },
  {
    label: "Жана Жол",
    ...
    lat: 40.7567,
    lng: 68.5661,
    keywords: ["жана жол", "жаңа жол", "жанажол", "zhana zhol"]
  },
  {
    label: "Мактаарал",
  ...
  },
  {
    ...
    lat: 40.8121,
    lng: 68.5839,
    keywords: ["атамекен", "ата мекен", "atameken"]
  }
];
...
const REGION_SEARCH_ALIASES = {
  ...
  "киров": ["киров", "кирово", "kirov", "мактаарал", "maktaaral"],
  "асыката": ["асыката", "асықата", "asykata", "жетысай", "zhetysay"],
  "достык": ["достык", "достық", "dostyk", "мактаарал", "maktaaral"],
  "ынтымак": ["ынтымак", "ынтымақ", "yntymak", "мактаарал", "maktaaral"],
  "бирлик": ["бирлик", "бірлік", "birlik", "мактаарал", "maktaaral"],
  "фирдоуси": ["фирдоуси", "фердоуси", "firdousi", "мактаарал", "maktaaral"],
  "жана жол": ["жана жол", "жаңа жол", "жанажол", "zhana zhol", "мактаарал", "maktaaral"],
  "мактаарал": ["мактаарал", "мақтаарал", "maktaaral"],
  "атамекен": ["атамекен", "ата мекен", "atameken", "мактаарал", "maktaaral"]
};
